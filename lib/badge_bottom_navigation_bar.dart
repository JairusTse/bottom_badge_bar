...
import 'badge_bottom_navigation_bar_item.dart';
...
enum BadgeBottomNavigationBarType {
...
class BadgeBottomNavigationBar extends StatefulWidget {
  ...
  BadgeBottomNavigationBar({
    ...
    this.currentIndex = 0,
    this.elevation = 8.0,
    BadgeBottomNavigationBarType type,
    Color fixedColor,
    ...
    bool showUnselectedLabels,
        ...
        assert(
        items.every((BadgeBottomNavigationBarItem item) => item.title !=
            null) == true,
  ...
  final List<BadgeBottomNavigationBarItem> items;
  ...
  final BadgeBottomNavigationBarType type;
  ...
  static BadgeBottomNavigationBarType _type(
      BadgeBottomNavigationBarType type,
      List<BadgeBottomNavigationBarItem> items,
      ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3 ? BadgeBottomNavigationBarType.fixed : BadgeBottomNavigationBarType.shifting;
  }
  ...
  static bool _defaultShowUnselected(BadgeBottomNavigationBarType type) {
    switch (type) {
      case BadgeBottomNavigationBarType.shifting:
        return false;
      case BadgeBottomNavigationBarType.fixed:
        return true;
    }
    assert(false);
    return false;
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final BadgeBottomNavigationBarType type;
  final BadgeBottomNavigationBarItem item;
...
class _Badge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    EdgeInsetsGeometry padding = item.padding;
    //设置默认边距
    if(padding == null) {
...
class _BottomNavigationBarState extends State<BadgeBottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(BadgeBottomNavigationBar oldWidget) {
